...
const HeroImage = ({ src, alt }: { src: string; alt: string }) => {
  ...
  return (
    <div className="relative z-10 w-full aspect-[4/5] sm:aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-500 border-8 border-white dark:border-slate-800 bg-slate-200 dark:bg-slate-800">
      <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-md sm:max-w-2xl lg:mx-0 leading-relaxed min-h-[84px]">
              {current.description}
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-10">
              <Link
                href="/projects"
                className={`group w-full sm:w-auto flex items-center justify-center text-white px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-xl dark:shadow-none ${
                  platform === "shopify"
              ...
              <Link
                href="/contact"
                className={`w-full sm:w-auto flex items-center justify-center bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white px-8 py-4 rounded-xl font-bold text-lg transition-all ${
                  platform === "shopify"
          ...
          {/* Image & Stats */}
          <div className="flex-1 relative min-w-0 w-full sm:w-3/4 lg:w-full mt-12 lg:mt-0">
            <HeroImage
            ...
            {/* Floating Card 1 */}
            <div className="absolute -bottom-6 -left-6 bg-white dark:bg-slate-800 p-6 rounded-xl shadow-xl z-20 hidden sm:block border border-slate-100 dark:border-slate-700 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
            ...
            {/* Floating Card 2 */}
            <div className="absolute -top-6 -right-6 bg-white dark:bg-slate-800 p-6 rounded-xl shadow-xl z-20 hidden sm:block border border-slate-100 dark:border-slate-700">
              <div className="flex items-center space-x-3">
